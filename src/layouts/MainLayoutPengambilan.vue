        ...
        <q-toolbar>
          <q-toolbar-title>
            <q-item-label header>
              ...
              />
              <img
                src="/images/logo_unisza.png"
                style="padding-left: 15px"
                class="adjusted-image"
              />
              <img
                src="/images/idfiw.png"
          ...
          >
            ...
            <q-list class="submenu">
              <q-item>
                <q-item-section>
                  <q-item-label>
                    <a href="#/saringan" style="color: white"
                      >Saringan Permohonan</a
                    >
                  </q-item-label>
                </q-item-section>
              </q-item>
          ...
          >
            <q-list class="submenu">
              <q-item>
                <q-item-section>
                  <q-item-label>
                    <a href="#/kelulusan" style="color: white"
                      >Kelulusan Permohonan</a
                    >
                  </q-item-label>
                </q-item-section>
              </q-item>
